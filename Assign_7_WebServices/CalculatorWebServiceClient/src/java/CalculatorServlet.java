...
import com.mortal.MyCalculator_Service;
...
public class CalculatorServlet extends HttpServlet {
    ...
    @WebServiceRef(wsdlLocation = "WEB-INF/wsdl/localhost_8080/Calculator/MyCalculator.wsdl")
    private MyCalculator_Service service;
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            // Retrieve the values of the parameters from the request
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet Calculator Output</title>");            
            out.println("</head>");
            out.println("<body>");
    ...
    private double addition(double num1, double num2) {
        ...
        com.mortal.MyCalculator port = service.getMyCalculatorPort();
