 ...
 * generated in the com.mortal package. 
...
public class ObjectFactory {
    ...
    private final static QName _Addition_QNAME = new QName("http://mortal.com/", "addition");
    private final static QName _AdditionResponse_QNAME = new QName("http://mortal.com/", "additionResponse");
    private final static QName _Division_QNAME = new QName("http://mortal.com/", "division");
    private final static QName _DivisionResponse_QNAME = new QName("http://mortal.com/", "divisionResponse");
    private final static QName _Multiplication_QNAME = new QName("http://mortal.com/", "multiplication");
    private final static QName _MultiplicationResponse_QNAME = new QName("http://mortal.com/", "multiplicationResponse");
    private final static QName _Subtraction_QNAME = new QName("http://mortal.com/", "subtraction");
    private final static QName _SubtractionResponse_QNAME = new QName("http://mortal.com/", "subtractionResponse");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: com.mortal
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://mortal.com/", name = "addition")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://mortal.com/", name = "additionResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://mortal.com/", name = "division")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://mortal.com/", name = "divisionResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://mortal.com/", name = "multiplication")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://mortal.com/", name = "multiplicationResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://mortal.com/", name = "subtraction")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://mortal.com/", name = "subtractionResponse")
